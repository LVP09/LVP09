...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LVP09\\SQLEXPRESS;Initial Catalog=QLBH;Persist Security Info=True;User ID=sa;Password=p01248460961");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KhachHang>(entity =>
            {
                entity.HasKey(e => e.DienThoai)
                    .HasName("PK__KhachHan__1F031877F224A4BC");
                ...
                entity.HasOne(d => d.MaNvNavigation)
                    ...
                    .HasForeignKey(d => d.MaNv)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__KhachHang__MaNV__239E4DCF");
            });

            modelBuilder.Entity<NhanVien>(entity =>
            {
                entity.HasKey(e => e.MaNv)
                    .HasName("PK__NhanVien__2725D70A874AE81A");
